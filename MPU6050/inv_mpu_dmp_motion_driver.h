...
#define DMP_FEATURE_TAP             (0x001)//taping wayback
#define DMP_FEATURE_ANDROID_ORIENT  (0x002)//Android兼容
#define DMP_FEATURE_LP_QUAT         (0x004)//200HZ accel only output
#define DMP_FEATURE_PEDOMETER       (0x008)//计步器功能
#define DMP_FEATURE_6X_LP_QUAT      (0x010)//200hz accel and gyro output
